...
| Name | Description |
|------|-------------|
|[__invoke](#alert__invoke)|Generates an 'alert' element|
...
```php
public __invoke (string $sContent, string|array $aOptionsAndAttributes, bool $bEscape)
```
...
* `(string|array) $aOptionsAndAttributes`
