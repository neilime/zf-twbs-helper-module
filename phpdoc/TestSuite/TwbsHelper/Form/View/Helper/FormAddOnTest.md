# TestSuite\TwbsHelper\Form\View\Helper\FormAddOnTest  
...
| Name | Description |
|------|-------------|
|[setUp](#formaddontestsetup)||
|[testInvokeReturnAddOnMarkup](#formaddontesttestinvokereturnaddonmarkup)||
|[testInvokeWithoutArgumentsReturnSelf](#formaddontesttestinvokewithoutargumentsreturnself)||
|[testRenderAddOnWithElementInstance](#formaddontesttestrenderaddonwithelementinstance)||
|[testRenderAddOnWithWrongContentOptionThrowsAnException](#formaddontesttestrenderaddonwithwrongcontentoptionthrowsanexception)||
|[testRenderAddOnWithWrongElementOptionThrowsAnException](#formaddontesttestrenderaddonwithwrongelementoptionthrowsanexception)||
|[testRenderAddOnWithWrongLabelOptionThrowsAnException](#formaddontesttestrenderaddonwithwronglabeloptionthrowsanexception)||
|[testRenderAddOnWithWrongTextOptionThrowsAnException](#formaddontesttestrenderaddonwithwrongtextoptionthrowsanexception)||
|[testRenderAddOnWithWrongTypeAsOptionThrowsAnException](#formaddontesttestrenderaddonwithwrongtypeasoptionthrowsanexception)||
...
### FormAddOnTest::testInvokeReturnAddOnMarkup  

**Description**

```php
 testInvokeReturnAddOnMarkup (void)
```
...
### FormAddOnTest::testInvokeWithoutArgumentsReturnSelf  

**Description**

```php
 testInvokeWithoutArgumentsReturnSelf (void)
```
...
### FormAddOnTest::testRenderAddOnWithElementInstance  

**Description**

```php
 testRenderAddOnWithElementInstance (void)
```
...
### FormAddOnTest::testRenderAddOnWithWrongContentOptionThrowsAnException  

**Description**

```php
 testRenderAddOnWithWrongContentOptionThrowsAnException (void)
```
...
### FormAddOnTest::testRenderAddOnWithWrongElementOptionThrowsAnException  

**Description**

```php
 testRenderAddOnWithWrongElementOptionThrowsAnException (void)
```
...
### FormAddOnTest::testRenderAddOnWithWrongLabelOptionThrowsAnException  

**Description**

```php
 testRenderAddOnWithWrongLabelOptionThrowsAnException (void)
```
...
### FormAddOnTest::testRenderAddOnWithWrongTextOptionThrowsAnException  

**Description**

```php
 testRenderAddOnWithWrongTextOptionThrowsAnException (void)
```
...
### FormAddOnTest::testRenderAddOnWithWrongTypeAsOptionThrowsAnException  

**Description**

```php
 testRenderAddOnWithWrongTypeAsOptionThrowsAnException (void)
```
