# TestSuite\TwbsHelper\Form\View\Helper\FormButtonTest  
...
| Name | Description |
|------|-------------|
|[setUp](#formbuttontestsetup)||
|[testRenderIconWithArrayIconOption](#formbuttontesttestrendericonwitharrayiconoption)||
|[testRenderIconWithStringIconOption](#formbuttontesttestrendericonwithstringiconoption)||
|[testRenderWithWrongIconOptionThrowsAnException](#formbuttontesttestrenderwithwrongiconoptionthrowsanexception)||
|[testRenderWithWrongIconPositionOptionThrowsAnException](#formbuttontesttestrenderwithwrongiconpositionoptionthrowsanexception)||
|[testRenderWithWrongPopoverOptionThrowsAnException](#formbuttontesttestrenderwithwrongpopoveroptionthrowsanexception)||
|[testRenderWithWrongTypeElementThrowsAnException](#formbuttontesttestrenderwithwrongtypeelementthrowsanexception)||
|[testRenderWithWrongTypeIconClassOptionThrowsAnException](#formbuttontesttestrenderwithwrongtypeiconclassoptionthrowsanexception)||
|[testRenderWithWrongTypeIconPositionOptionThrowsAnException](#formbuttontesttestrenderwithwrongtypeiconpositionoptionthrowsanexception)||
|[testRenderWithoutButtonContentThrowsAnException](#formbuttontesttestrenderwithoutbuttoncontentthrowsanexception)||
|[testRenderWithoutIconClassOptionThrowsAnException](#formbuttontesttestrenderwithouticonclassoptionthrowsanexception)||
...
### FormButtonTest::testRenderIconWithArrayIconOption  

**Description**

```php
 testRenderIconWithArrayIconOption (void)
```
...
### FormButtonTest::testRenderIconWithStringIconOption  

**Description**

```php
 testRenderIconWithStringIconOption (void)
```
...
### FormButtonTest::testRenderWithWrongIconOptionThrowsAnException  

**Description**

```php
 testRenderWithWrongIconOptionThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithWrongIconPositionOptionThrowsAnException  

**Description**

```php
 testRenderWithWrongIconPositionOptionThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithWrongPopoverOptionThrowsAnException  

**Description**

```php
 testRenderWithWrongPopoverOptionThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithWrongTypeElementThrowsAnException  

**Description**

```php
 testRenderWithWrongTypeElementThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithWrongTypeIconClassOptionThrowsAnException  

**Description**

```php
 testRenderWithWrongTypeIconClassOptionThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithWrongTypeIconPositionOptionThrowsAnException  

**Description**

```php
 testRenderWithWrongTypeIconPositionOptionThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithoutButtonContentThrowsAnException  

**Description**

```php
 testRenderWithoutButtonContentThrowsAnException (void)
```
...
### FormButtonTest::testRenderWithoutIconClassOptionThrowsAnException  

**Description**

```php
 testRenderWithoutIconClassOptionThrowsAnException (void)
```
