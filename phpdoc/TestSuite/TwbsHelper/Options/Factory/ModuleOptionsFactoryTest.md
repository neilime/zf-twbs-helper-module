# TestSuite\TwbsHelper\Options\Factory\ModuleOptionsFactoryTest  
...
| Name | Description |
|------|-------------|
|[setUp](#moduleoptionsfactorytestsetup)||
|[testCreateService](#moduleoptionsfactorytesttestcreateservice)||
...
### ModuleOptionsFactoryTest::setUp  
...
### ModuleOptionsFactoryTest::testCreateService  

**Description**

```php
 testCreateService (void)
```
