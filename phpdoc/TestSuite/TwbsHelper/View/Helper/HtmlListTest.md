# TestSuite\TwbsHelper\View\Helper\HtmlListTest  
...
| Name | Description |
|------|-------------|
|[testInvokeWithDirectNestedList](#htmllisttesttestinvokewithdirectnestedlist)||
|[testInvokeWithEmptyArgumentItems](#htmllisttesttestinvokewithemptyargumentitems)||
|[testInvokeWithoutPredefinedAttributes](#htmllisttesttestinvokewithoutpredefinedattributes)||
...
### HtmlListTest::testInvokeWithDirectNestedList  

**Description**

```php
 testInvokeWithDirectNestedList (void)
```
...
### HtmlListTest::testInvokeWithEmptyArgumentItems  

**Description**

```php
 testInvokeWithEmptyArgumentItems (void)
```
...
### HtmlListTest::testInvokeWithoutPredefinedAttributes  

**Description**

```php
 testInvokeWithoutPredefinedAttributes (void)
```
