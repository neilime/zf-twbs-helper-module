# TestSuite\TwbsHelper\View\Helper\FigureTest  
...
| Name | Description |
|------|-------------|
|[testInvokeWithExistingClassAttribute](#figuretesttestinvokewithexistingclassattribute)||
|[testInvokeWithExistingImageClassAttribute](#figuretesttestinvokewithexistingimageclassattribute)||
...
### FigureTest::testInvokeWithExistingClassAttribute  

**Description**

```php
 testInvokeWithExistingClassAttribute (void)
```
...
### FigureTest::testInvokeWithExistingImageClassAttribute  

**Description**

```php
 testInvokeWithExistingImageClassAttribute (void)
```
