# TestSuite\TwbsHelper\View\Helper\AbbreviationTest  
...
| Name | Description |
|------|-------------|
|[testInvokeWithInitialismAndExistingClassAttribute](#abbreviationtesttestinvokewithinitialismandexistingclassattribute)||
...
### AbbreviationTest::testInvokeWithInitialismAndExistingClassAttribute  

**Description**

```php
 testInvokeWithInitialismAndExistingClassAttribute (void)
```
