# TestSuite\TwbsHelper\View\Helper\ButtonToolbarTest  
...
| Name | Description |
|------|-------------|
|[testGetButtonGroupHelperLazyLoad](#buttontoolbartesttestgetbuttongrouphelperlazyload)||
|[testGetFormElementHelperLazyLoad](#buttontoolbartesttestgetformelementhelperlazyload)||
|[testRenderWithWrongToolbarItem](#buttontoolbartesttestrenderwithwrongtoolbaritem)||
...
### ButtonToolbarTest::testGetButtonGroupHelperLazyLoad  

**Description**

```php
 testGetButtonGroupHelperLazyLoad (void)
```
...
### ButtonToolbarTest::testGetFormElementHelperLazyLoad  

**Description**

```php
 testGetFormElementHelperLazyLoad (void)
```
...
### ButtonToolbarTest::testRenderWithWrongToolbarItem  

**Description**

```php
 testRenderWithWrongToolbarItem (void)
```
