# TestSuite\TwbsHelper\View\Helper\TableTest  
...
| Name | Description |
|------|-------------|
|[testRenderHeadRowsWithEmptyRows](#tabletesttestrenderheadrowswithemptyrows)||
|[testRenderHeadRowsWithWrongAttributesType](#tabletesttestrenderheadrowswithwrongattributestype)||
|[testRenderHeadRowsWithWrongRowType](#tabletesttestrenderheadrowswithwrongrowtype)||
|[testRenderTableCellWithEmptyArgumentCell](#tabletesttestrendertablecellwithemptyargumentcell)||
|[testRenderTableCellWithUndefinedCellData](#tabletesttestrendertablecellwithundefinedcelldata)||
|[testRenderTableCellWithWrongTypeCellAttributes](#tabletesttestrendertablecellwithwrongtypecellattributes)||
|[testRenderTableCellWithWrongTypeCellData](#tabletesttestrendertablecellwithwrongtypecelldata)||
|[testRenderTableCellWithWrongTypeCellType](#tabletesttestrendertablecellwithwrongtypecelltype)||
|[testRenderTableRowWithWrongAttributesType](#tabletesttestrendertablerowwithwrongattributestype)||
|[testRenderTableRowWithWrongCellsType](#tabletesttestrendertablerowwithwrongcellstype)||
|[testRenderTableRowsWithEmptyRows](#tabletesttestrendertablerowswithemptyrows)||
|[testRenderTableRowsWithHeadDefinedInFirstBodyRow](#tabletesttestrendertablerowswithheaddefinedinfirstbodyrow)||
|[testRenderTableRowsWithWrongArgumentBody](#tabletesttestrendertablerowswithwrongargumentbody)||
|[testRenderTableRowsWithWrongArgumentHead](#tabletesttestrendertablerowswithwrongargumenthead)||
|[testRenderTableRowsWithWrongRowType](#tabletesttestrendertablerowswithwrongrowtype)||
...
### TableTest::testRenderHeadRowsWithEmptyRows  

**Description**

```php
 testRenderHeadRowsWithEmptyRows (void)
```
...
### TableTest::testRenderHeadRowsWithWrongAttributesType  

**Description**

```php
 testRenderHeadRowsWithWrongAttributesType (void)
```
...
### TableTest::testRenderHeadRowsWithWrongRowType  

**Description**

```php
 testRenderHeadRowsWithWrongRowType (void)
```
...
### TableTest::testRenderTableCellWithEmptyArgumentCell  

**Description**

```php
 testRenderTableCellWithEmptyArgumentCell (void)
```
...
### TableTest::testRenderTableCellWithUndefinedCellData  

**Description**

```php
 testRenderTableCellWithUndefinedCellData (void)
```
...
### TableTest::testRenderTableCellWithWrongTypeCellAttributes  

**Description**

```php
 testRenderTableCellWithWrongTypeCellAttributes (void)
```
...
### TableTest::testRenderTableCellWithWrongTypeCellData  

**Description**

```php
 testRenderTableCellWithWrongTypeCellData (void)
```
...
### TableTest::testRenderTableCellWithWrongTypeCellType  

**Description**

```php
 testRenderTableCellWithWrongTypeCellType (void)
```
...
### TableTest::testRenderTableRowWithWrongAttributesType  

**Description**

```php
 testRenderTableRowWithWrongAttributesType (void)
```
...
### TableTest::testRenderTableRowWithWrongCellsType  

**Description**

```php
 testRenderTableRowWithWrongCellsType (void)
```
...
### TableTest::testRenderTableRowsWithEmptyRows  

**Description**

```php
 testRenderTableRowsWithEmptyRows (void)
```
...
### TableTest::testRenderTableRowsWithHeadDefinedInFirstBodyRow  

**Description**

```php
 testRenderTableRowsWithHeadDefinedInFirstBodyRow (void)
```
...
### TableTest::testRenderTableRowsWithWrongArgumentBody  

**Description**

```php
 testRenderTableRowsWithWrongArgumentBody (void)
```
...
### TableTest::testRenderTableRowsWithWrongArgumentHead  

**Description**

```php
 testRenderTableRowsWithWrongArgumentHead (void)
```
...
### TableTest::testRenderTableRowsWithWrongRowType  

**Description**

```php
 testRenderTableRowsWithWrongRowType (void)
```
