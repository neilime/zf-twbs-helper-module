# TestSuite\TwbsHelper\View\Helper\ButtonGroupTest  
...
| Name | Description |
|------|-------------|
|[testGetFormElementHelperLazyLoad](#buttongrouptesttestgetformelementhelperlazyload)||
|[testRenderWithWrongButtonItem](#buttongrouptesttestrenderwithwrongbuttonitem)||
...
### ButtonGroupTest::testGetFormElementHelperLazyLoad  
...
### ButtonGroupTest::testRenderWithWrongButtonItem  

**Description**

```php
 testRenderWithWrongButtonItem (void)
```
